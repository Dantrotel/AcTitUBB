...
-- Vista de Entregas Finales Pendientes de Revisión por Profesor de Asignatura
...
LEFT JOIN asignaciones_proyectos ap ON ap.proyecto_id = p.id 
    AND ap.rol_profesor_id = (SELECT id FROM roles_profesores WHERE nombre = 'Profesor de Asignatura')
    AND ap.activo = TRUE
...
('Profesor Revisor', 'Evalúa y revisa la propuesta inicial'),
('Profesor Guía', 'Guía principal del proyecto de titulación'),
('Profesor de Sala', 'Participa en la defensa oral (solo ICINF)'),
('Profesor Informante', 'Profesor informante que apoya el proyecto');
...
CREATE TABLE IF NOT EXISTS versiones_documento (
    ...
    autor_rol ENUM('estudiante', 'profesor_guia', 'profesor_asignatura', 'admin') NOT NULL,
...
-- =====================================================
-- MIGRACIONES ADICIONALES INTEGRADAS
-- =====================================================
