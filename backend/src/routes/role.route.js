...
routerRole.get('/profesores', verifySession, checkRole('1','4'), roleController.getRolesProfesores);

// ============= RUTAS PARA GESTIÓN DE ASIGNACIONES =============

// Asignar profesor a proyecto con rol específico (solo admin)
routerRole.post('/asignaciones', verifySession, checkRole('1','4'), roleController.asignarProfesorAProyecto);

// Desasignar profesor de proyecto (solo admin)
routerRole.delete('/asignaciones/:asignacion_id', verifySession, checkRole('1','4'), roleController.desasignarProfesorDeProyecto);
...
routerRole.get('/asignaciones/estadisticas', verifySession, checkRole('1','4'), roleController.getEstadisticasAsignaciones);

// Obtener historial de asignaciones (solo admin)
routerRole.get('/asignaciones/historial', verifySession, checkRole('1','4'), roleController.getHistorialAsignaciones);
