...
CREATE TABLE `colaboradores_externos` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `password_hash` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Hash de contraseña para acceso al sistema',
  `token_acceso` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Token único para primer acceso',
...
CREATE TABLE `evaluaciones_colaboradores` (
  ...
  `estudiante_rut` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'RUT del estudiante evaluado',
  ...
  `comentarios` text COLLATE utf8mb4_unicode_ci COMMENT 'Comentarios y observaciones',
  `fortalezas` text COLLATE utf8mb4_unicode_ci COMMENT 'Fortalezas identificadas',
  `areas_mejora` text COLLATE utf8mb4_unicode_ci COMMENT 'Áreas de mejora identificadas',
  `recomendaria_contratar` enum('si','no','tal_vez') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '¿Recomendaría contratar al estudiante?',
  `comentario_recomendacion` text COLLATE utf8mb4_unicode_ci COMMENT 'Comentario sobre la recomendación',
...
INSERT INTO `mensajes` VALUES (1,1,'11111111-1','Hola profe, esto es un test del chat!',0,NULL,'2026-02-25 05:02:47'),(2,1,'11111111-1','hola profe',0,NULL,'2026-02-26 23:49:41');
...
INSERT INTO `mensajes_no_leidos` VALUES ('22222222-2',1,2,'2026-02-26 23:49:41');
...
CREATE TABLE `notificaciones_colaboradores` (
  ...
  `tipo` enum('asignacion_proyecto','solicitud_evaluacion','recordatorio_evaluacion','mensaje_profesor','actualizacion_proyecto') COLLATE utf8mb4_unicode_ci NOT NULL,
  `titulo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Título de la notificación',
  ...
  `url_accion` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'URL a la que debe dirigirse',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `proyecto_id` (`proyecto_id`),
...
CREATE TABLE `tokens_colaboradores` (
  `id` int NOT NULL AUTO_INCREMENT,
  `colaborador_id` int NOT NULL COMMENT 'ID del colaborador',
  `token` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Token único de acceso',
  `tipo` enum('activacion','reset_password','acceso_temporal') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tipo de token',
  ...
  `ip_uso` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'IP desde donde se usó',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `versiones_propuestas` (
  ...
  `modalidad` enum('desarrollo_software','investigacion','practica') COLLATE utf8mb4_unicode_ci NOT NULL,
  `numero_estudiantes` int NOT NULL DEFAULT '1',
  ...
  `motivo_cambio` enum('creacion','correccion_solicitada','mejora_voluntaria','revision_profesor') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'correccion_solicitada',
  `comentario_cambio` text COLLATE utf8mb4_unicode_ci COMMENT 'Comentario del estudiante sobre qué cambió',
  `creado_por` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2026-02-27 17:40:29
